...
/**
 * 
 * @TableName tb_roll_room_accessories
 */
@TableName(value ="tb_roll_room_accessories")
@Data
public class RollRoomAccessories implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        RollRoomAccessories other = (RollRoomAccessories) that;
