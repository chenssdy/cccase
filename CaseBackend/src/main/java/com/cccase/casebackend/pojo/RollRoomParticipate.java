...
/**
 * 
 * @TableName tb_roll_room_participate
 */
@TableName(value ="tb_roll_room_participate")
@Data
public class RollRoomParticipate implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        RollRoomParticipate other = (RollRoomParticipate) that;
